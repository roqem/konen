...
# Add tools, system packages, repositories and managed files with Konen or edit
# this native mise file directly. Put personal commands in scripts/bin and
# custom installer tasks in mise-tasks/install.
